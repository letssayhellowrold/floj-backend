package com.flexilearnoj.flexilearnojbackendquestionservice.controller;
...
import com.flexilearnoj.flexilearnojbackendmodel.model.dto.question.*;
...
public class QuestionController {
    ...
    public BaseResponse<Question> getQuestionById(long id, HttpServletRequest request) {
        ...
        if(!question.getUserId().equals(loginUser.getId()) && !userFeignClient.isAdmin(loginUser)) {
            // 题目访问者不是题目创建者 且不是管理员
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR);// 无权限异常
        }
