...
import com.flexilearnoj.flexilearnojbackendquestionservice.mapper.QuestionMapper;
...
//    private ElasticsearchRestTemplate elasticsearchRestTemplate;
    ...
    public QueryWrapper<Question> getQueryWrapper(QuestionQueryRequest questionQueryRequest) {
        ...
        // 拼接查询条件
        queryWrapper.like(StringUtils.isNotBlank(title), "title", title);// like 为模糊判断
        ...
        queryWrapper.eq(ObjectUtils.isNotEmpty(id), "id", id);// eq 相等判断
    ...
    public QuestionVO getQuestionVO(Question question, HttpServletRequest request) {
        QuestionVO questionVO = QuestionVO.objToVo(question);// 对象转封装类
